...
namespace Reload.Web.Helpers.Angular
{
	...
	{
		/// <summary>Generates a list of validation attributes as angular directives from the given expression.</summary>
		/// <typeparam name="TModel">The type of the model.</typeparam>
		/// <typeparam name="TProperty">The type of the property.</typeparam>
		/// <param name="htmlHelper">The HTML helper.</param>
		/// <param name="expression">The expression.</param>
		/// <returns>A string of html representing the angular directives from the given expression.</returns>
